...
Label(window,text='Developed By @Puspanjali Priyadarsini:2022',font=('bold',12),fg='purple').pack(side=BOTTOM)
...
Button(window,text='Block',font=('bold',10),bg='black',fg='white',command=block).place(x=150,y=100)
Button(window,text='Un Block',font=('bold',10),bg='green',fg='white',command=unblock).place(x=270,y=100)
Button(window,text='Exit',font=('bold',10),bg='red',fg='white',command=close).place(x=400,y=100)
window.mainloop()